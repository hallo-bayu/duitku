...
const MENU = [
  ...
  { icon: "🎯", label: "Target Keuangan",        href: "/profile" },
  { icon: "📂", label: "Kategori Pengeluaran",   href: "/recap" },
  { icon: "🤖", label: "Pengaturan AI",          href: "/profile" },
  { icon: "📤", label: "Export Data",            href: "/api/export?format=csv" },
];
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: open ? "4px 0 40px rgba(255,59,92,0.10)" : "none",
      ...
      >
        ...
        <div className="px-6 pt-6 pb-5 border-b border-white/[0.06]">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              { label: "Pengeluaran", value: formatRupiah(spent), color: "#FF3B5C" },
              { label: "Budget", value: formatRupiah(budget), color: "#fff" },
              { label: "Sisa", value: formatRupiah(remaining), color: remaining > 0 ? "#4ade80" : "#FF3B5C" },
            ].map(s => (
        ...
        <div className="px-4 pb-6 border-t border-white/[0.06] pt-4"
          ...
          <div className="flex items-center justify-between px-2 mb-3">
            ...
            <span className="text-[#444] text-xs">Duitku v3</span>
          </div>
